...
export default async function DemoPage({ searchParams }: { searchParams: Promise<{ owner?: string; module?: string }> }) {
  ...
  const demoSource = ownerMode ? `/fireflow-360-demo.html?v=20260814-station-display${ownerModule}` : "/fireflow-360-demo.html?view=readonly&v=20260814-station-display";
