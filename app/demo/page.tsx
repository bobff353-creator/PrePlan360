...
export default async function DemoPage({ searchParams }: { searchParams: Promise<{ owner?: string; module?: string }> }) {
  ...
  const demoSource = ownerMode ? `/fireflow-360-demo.html?v=20260814-apparatus-roster-maps${ownerModule}` : "/fireflow-360-demo.html?view=readonly&v=20260814-apparatus-roster-maps";
