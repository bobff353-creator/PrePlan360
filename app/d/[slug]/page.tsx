...
function Dashboard({ department, stations, vehicles, weather, supportQuery, modules: dashboardModules }: { department: string; stations: number; vehicles: number; weather: string; supportQuery: string; modules: string[][] }) {
