...
const definitions: Record<StickneyEditableRecordType, { permission: DepartmentPermission; module: string; fields: Record<string, number> }> = {
  ...
  duty: { permission: "duties", module: "duties", fields: { day_of_week: 1, shift_key: 100, duty: 3000, detail: 3000, category: 120, assigned_to: 160, due_time: 20, completed_date: 20 } },
